 ...
 * 6. Выделение юнита DONE
 * 7. Все добавленные панели UI должны быть выдвижными DONE (не плавно)
 * 
...
Кнопка “Отобразить здоровье” - открывает/скрывает шкалы здоровья над каждым юнитом DONE
